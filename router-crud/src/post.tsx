        ...
        <div className="post w-100 d-flex p-2 block flex-column gap-4">
            ...
            <div className="d-flex flex-column gap-4">
                <div className="d-flex justify-content-between">
                    ...
                    {closeBtnLink ?
                        <CloseButton className="align-self-start" type="button"
                                     onClick={() => navigate(closeBtnLink)}/> : null}
                </div>
                <div className="content block - shadow" title={closeBtnLink ? "" : "Go to post"}
                     onClick={() => !closeBtnLink ? navigate(`/posts/${id}`) : null}>{content}</div>
            </div>
